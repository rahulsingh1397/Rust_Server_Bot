...
Automatically sends messages about server status, wipes, and player count to Discord
"""
...
# Configuration
SERVER_NAME = "IND-US Valley [Vanilla+ | Weekly | Merged Outpost | Max : 5]"  # Replace with your server name for BattleMetrics API
...
def main():
    ...
    while True:
        try:
            ...
            # You can manually trigger restart alerts by uncommenting:
            # send_restart_alert()
